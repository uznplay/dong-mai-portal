/**
 * Vietnamese Lunar Calendar Algorithm (Simplified & Reliable)
...
/**
 * Returns lunar day, month, and indicator if leap month
 */
...
function lYearDays(y) {
    let i, sum = 348;
    for (i = 0x8000; i > 0x8; i >>= 1) sum += (LUNAR_DATA[y - 1900] & i) ? 1 : 0;
...
function leapDays(y) {
    if (leapMonth(y)) return (LUNAR_DATA[y - 1900] & 0x10000) ? 30 : 29;
    return 0;
}
